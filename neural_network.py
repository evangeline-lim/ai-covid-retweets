...
# Read dataset
dataset_1 = pd.read_csv('data/1_9_retweets.csv')
...
xtrain_scale_1 = scaler_x_1.fit_transform(x_train_1)
xval_scale_1 = scaler_x_1.transform(x_val_1)

ytrain_scale_1 = scaler_y_1.fit_transform(y_train_1)
yval_scale_1 = scaler_y_1.transform(y_val_1)

joblib.dump(scaler_x_1, 'data/scaler_x_1.save') 
joblib.dump(scaler_y_1, 'data/scaler_y_1.save')
...
predictions_1 = scaler_y_1.inverse_transform(predictions_1)
...
with open("data/model1.json", "w") as json_file:
