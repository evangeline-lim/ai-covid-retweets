...
# Read dataset
dataset_1 = pd.read_csv('data/10_99_retweets.csv')
...
xtrain_scale_1 = scaler_x_2.fit_transform(x_train_1)
xval_scale_1 = scaler_x_2.transform(x_val_1)

ytrain_scale_1 = scaler_y_2.fit_transform(y_train_1)
yval_scale_1 = scaler_y_2.transform(y_val_1)

joblib.dump(scaler_x_2, 'data/scaler_x_2.save') 
joblib.dump(scaler_y_2, 'data/scaler_y_2.save')
...
predictions_1 = scaler_y_2.inverse_transform(predictions_1)
...
with open("data/model2.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model1.save_weights("data/model2.h5")
